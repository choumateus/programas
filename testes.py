...
while rodar2!= "nao":
    ...
    #print()
    #print()
    #norma2c.append(norma_2(resolve_chulesky(u,l,y)))
    #tempo1=time.time()
    ...
    #print()
    #norma2s.append(norma_2(sem_pivo_2(a)))
    #tempo1=time.time()
    #print("solucao encontrada pelo algoritmo pronto do numpy: ", np.linalg.solve(a,y))
    #print()
    #norma2l.append(norma_2(np.linalg.solve(a,y)))
    #tempo2=time.time()
    #print("tempo computacional: " , tempo2-tempo1)
    #print()
    ...
    detv.append(det)
    print(det)
    #print(norma_2(resolve_chulesky(u,l,y)),"&",norma_2(sem_pivo_2(a)))
    #print("&",norma_2(np.linalg.solve(a,y)),"&",det)
    print()
    n*=2
    input()
