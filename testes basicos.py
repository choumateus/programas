...
#while rodar != "nao":
    ...
    #erro_sem_pivo.append(norma_2(sem_pivo(n)))
    #print()
    #
    #print("determinante da matriz de hilbert", determinante(gerador(n)))
    #determinante_v.append(determinante(gerador(n)))
''' print()
    ...
    erro_com_pivo.append(norma_2(pivotamento_parcial(n)))
    print()
    ...
    if rodar != "nao":
        ...
        n+=x
import matplotlib.pyplot as plt
plt.plot(erro_sem_pivo, color = 'r')
plt.plot(erro_com_pivo)
plt.plot(determinante_v,color='b')
plt.xlabel('vermelho = sem pivotamento , azul = pivotamento parcial')
plt.show() '''
import random
...
while n<101:
    ...
    vetor_cholesky.append(norma_2(resolve_chulesky(u,l,y)))
    #print(vetor_cholesky)
    #n=int(input("entra com n: "))
    #print()
    #tempo2=time.time()
    ...
    vetor_sempivo.append(norma_2(sem_pivo_2(a)))
    print()
    #tempo2=time.time()
    #print("tempo computacional: " , tempo2-tempo1)
    print()
    ...
    print()
    vetor_pronto.append(norma_2(np.linalg.solve(a,y)))
    #tempo2=time.time()
    #print("tempo computacional: " , tempo2-tempo1)
    print()
    ...
    print()
    #print(norma_2(resolve_chulesky(u,l,y)), "&", norma_2(sem_pivo_2(a)),"&",norma_2(np.linalg.solve(a,y)))
    #rodar2 = input("continuo rodando essa parte? (sim ou nao) ")
    n+=1
plt.plot(vetor_cholesky,color='r')
plt.plot(vetor_sempivo,color='b')
plt.plot(vetor_pronto)
plt.xlabel("vermelho = cholesky | azul claro = linalg | azul escuro = sem pivo")
plt.show()
